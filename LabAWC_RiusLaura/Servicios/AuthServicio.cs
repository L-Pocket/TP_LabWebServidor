...
namespace Restaurante_API.Servicios
{
    public class AuthServicio
    {
        ...
        public string CreateToken(LoginRequestDto usuario, string rol, int empleadoId, int sectorId)
        {
            ...
            Claim[] claims = new[]
            {
                ...
                new Claim("EmpleadoId", empleadoId.ToString()), // Claim con el empleadoId para el deslogueo
                new Claim("SectorId", sectorId.ToString()) // Claim con el SectorId
